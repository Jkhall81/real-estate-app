...
class Gender(models.TextChoices):
    MALE = 'Male', _('Male')
    FEMAILE = 'Female', _('Female')
    OTHER = 'Other', _('Other')
    
    
class Profile(TimeStampedUUIDModel):
    user = models.OneToOneField(User, related_name="profile", on_delete=models.CASCADE)
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+16025188301')
    ...
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Phoenix', blank=False, null=False)
