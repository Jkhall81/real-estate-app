...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Phoenix")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="85308")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="1234 3rd Ave")
